# REST - Representative State Transfter (web standard that uses
#  HTTP protocol to enable API calls (aka, METHOD or FUNCTION calls))

import json
import requests as req
from pprint import pprint as pp

# Read the API key from MY PRIVATE "API KEY STORE"
